...
class SettingsHubBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      padding: pagePadding(context, top: 14, bottom: 32),
      children: [
        if (state.user!.isAdmin) ...[
          ...
          _SettingsTile(
            ...
            onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const PresentersScreen())),
          ),
        ...
        _SettingsTile(
          ...
          title: 'Ganti Tema',
          subtitle: state.themeStyle == AppThemeStyle.pocket ? 'Pocket Ledger' : 'Teal Ledger',
  ...
  Widget build(BuildContext context) => Panel(
        ...
        child: ListTile(
          ...
          leading: Container(
            width: 48,
            height: 48,
            decoration: BoxDecoration(color: context.colors.mint, borderRadius: BorderRadius.circular(14), border: Border.all(color: context.colors.line)),
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: SingleChildScrollView(
        padding: EdgeInsets.fromLTRB(context.pageInset, 16, context.pageInset, 28),
